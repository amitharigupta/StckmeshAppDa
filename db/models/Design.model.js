...
var Design = sequelize.define('design',
    {
        ...
        stoneWtCode: { type: Sequelize.STRING, allowNull: true, default: null },
        beadWtCode: { type: Sequelize.STRING, allowNull: true, default: null },
        extraStoneWtCode: { type: Sequelize.STRING, allowNull: true, default: null },
